...
TERMUX_PKG_SHA256=cd190df9cedd3642b7042dd25e4ad9848ab4b229a2cae5fa2282383dfd62cf6a
...
termux_step_make_install() {
	install -Dm700 -t "${TERMUX_PKG_MASSAGEDIR}/${TERMUX_PREFIX}"/bin "$TERMUX_PKG_SRCDIR"/cmd/hz/hz
}
