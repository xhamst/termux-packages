...
termux_step_make_install() {
	...
	if [ $TERMUX_ARCH = "arm" ]; then
		...
		cp -r ./out/ReleaseAndroidARM64C/dart-sdk $TERMUX_PKG_MASSAGEDIR/${TERMUX_PREFIX}/lib
		...
		cp -r ./out/ReleaseAndroidX64C/dart-sdk $TERMUX_PKG_MASSAGEDIR/${TERMUX_PREFIX}/lib
	else
